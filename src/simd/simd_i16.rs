...
mod sse {
    ...
    impl SIMD<i16, __m128i, __m128i, LANE_SIZE> for SSE {
        ...
        #[inline(always)]
        unsafe fn _mm_load(data: *const i16) -> __m128i { _mm_loadu_si128(data as *const __m128i) }
...
mod avx512 { 
    ...
    impl SIMD<i16, __m512i, u32, LANE_SIZE> for AVX512 {
        ...
        #[inline(always)]
        unsafe fn _mm_load(data: *const i16) -> __m512i { _mm512_loadu_epi16(data as *const i16) }
