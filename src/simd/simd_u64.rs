...
unsafe fn _u64_to_i64decrord(u64: __m256i) -> __m256i {
    ...
    _mm256_xor_si256(u64, _mm256_set1_epi64x(0x7FFFFFFFFFFFFFFF))
}

#[inline(always)]
fn _decr_ord_i64_to_u64(ord_i64: i64) -> u64 {
    // let v = ord_i64 ^ 0x7FFFFFFFFFFFFFFF;
    unsafe { std::mem::transmute::<i64, u64>(ord_i64 ^ 0x7FFFFFFFFFFFFFFF) }
}

#[inline(always)]
fn _reg_to_i64_arr(reg: __m256i) -> [i64; LANE_SIZE] {
    unsafe { std::mem::transmute::<__m256i, [i64; LANE_SIZE]>(reg) }
}

impl SIMD<u64, __m256i, LANE_SIZE> for AVX2 {
    #[inline(always)]
    ...
    #[inline(always)]
    fn _mm_load(data: *const u64) -> __m256i {
        unsafe { _u64_to_i64decrord(_mm256_loadu_si256(data as *const __m256i)) }
    }
    ...
    fn _get_min_max_index_value(
        ...
        (max_index.as_(), _decr_ord_i64_to_u64(max_value), min_index.as_(), _decr_ord_i64_to_u64(min_value))
    }
}
