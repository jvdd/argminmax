...
// #[inline]
// pub(crate) fn simple_argmin<T: Copy + PartialOrd>(arr: ArrayView1<T>) -> usize {
...
// #[inline]
// pub(crate) fn simple_argmax<T: Copy + PartialOrd>(arr: ArrayView1<T>) -> usize {
...
// Note: 5-7% faster than the above implementation
#[inline]
pub fn simple_argminmax<T: Copy + PartialOrd>(arr: ArrayView1<T>) -> (usize, usize) {
